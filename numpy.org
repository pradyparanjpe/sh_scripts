...
#+PROPERTY: header-args  :tangle pss/bin/numpy :exports none
#+SETUPFILE: https://fniessen.github.io/org-html-themes/org/theme-readtheorg.setup
#+EXPORT_FILE_NAME: docs/numpy.html

* NAME
numpy - launch (i)python with numpy pre-imported
...
* DESCRIPTION
Launch python interpreter (ipython if available) with numpy already imported.
...
#+begin_src sh :shebang #!/usr/bin/env sh
  ...
  launch () {
      mod_call psprint/print numpy:np
      clean_exit $?
  }

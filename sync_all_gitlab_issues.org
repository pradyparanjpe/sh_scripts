...
#+EXPORT_FILE_NAME: docs/sync_all_gitlab_issues.html


* NAME
sync_all_gitlab_issues - Synchronize issues for all gitlab projects.

* SYNOPSIS
sync_all_gitlab_issues [-h]

sync_all_gitlab_issues [--help]

sync_all_gitlab_issues [[*Optional Arguments] ...] CONFIG_YAML


* DESCRIPTION
Synchronize issues for all gitlab projects.

A multi-wrapper for [[https://pypi.org/project/gitlab-issues-sync/]]
...
* FILES
Configuration file (yaml format) should contain following structure.
Yaml indent: 2 spaces.
#+begin_src yaml :tangle no :exports code
    BLOCK:
      local:
      ...
      # comment
      # inline comments WILL pollute value
      # yaml indentation: 2 spaces

#+end_src

#+begin_src sh :shebang #!/usr/bin/env bash :tangle pss/bin/sync_all_gitlab_issues :exports none
  # -*- coding:utf-8 -*-
  #

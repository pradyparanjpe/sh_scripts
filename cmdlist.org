...
#+begin_warn
Execution *shall* fail in most cases.
#+end_warn
...
#+begin_src sh :shebang #!/usr/bin/env sh
  ...
  set_cmds () {
      ...
      # shellcheck disable=SC2034
      pip_cmd="pip install -U pip setuptools build wheel"
  ...
  /pspman/src/spacemacs/\" pull"
      ...
      # shellcheck disable=SC2034
      nvim_cmd="nvim +CocUpdateSync +PlugUpdate +qall"
  ...
  --eval=\"(prady/cmd-update)\""

      all_cmds="dnf_cmd clamav_cmd pip_cmd cargo_cmd tldr_cmd spacemacs_cmd \
          nvim_cmd emacs_cmd emacs_cmd"
  }

...
* Configuration
  Variable values may be set manually in =${XDG_CONFIG_HOME:-${HOME/.config}}/sh_scripts/config.sh=.
  A variable named =<var>= for as script =<script>= can be set by declaring =<script>_<var>=<value>=.
  It will be interpreted as =<var>=<value>= only by *that* script, ignoring all other variables.
  #+begin_src sh
...
** [[../gen_self_ssl_cert.sh][gen_self_ssl_cert]]
...
** [[../get_pass.sh][get_pass]]
   - get_pass_instance: /str/

** [[../git_migrate.sh][git_migrate]]
...
** [[../scan_network_upnodes.sh][scan_network_upnodes]]

...
#+PROPERTY: header-args  :tangle pss/bin/countdown :exports none
#+SETUPFILE: https://fniessen.github.io/org-html-themes/org/theme-readtheorg.setup
#+EXPORT_FILE_NAME: docs/countdown.html


* NAME
countdown - Display a countdown timer on =STDOUT=, that updates every second.
...
countdown [-p|progress] [-n|--notify] [-u N|--update N] [-t|--time] PERIOD
...
[ This is parsed using =/usr/bin/date= ]

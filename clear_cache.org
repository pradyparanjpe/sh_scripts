...
#+PROPERTY: header-args  :tangle pss/bin/clear_cache :exports none
#+SETUPFILE: https://fniessen.github.io/org-html-themes/org/theme-readtheorg.setup
#+EXPORT_FILE_NAME: docs/clear_cache.html

* NAME
clear_cache - clear cache by passing '3' to =/proc/sys/vm/drop_caches=
...
clear_cache [-y|--assumeyes] [-n|--assumeno]

* DESCRIPTION
Clear cache by passing '3' to =/proc/sys/vm/drop_caches=
After confirmation, super-user privileges will be requested.
...
* FILES
Linux system file =/proc/sys/vm/drop_caches=.
